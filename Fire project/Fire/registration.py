...
l1 = tk.Label(window, text="Create Your Account Here!! ", font=("Times new roman", 30, "bold"), bg="white", fg="black")
l1.place(x=120, y=50)
...
btn = tk.Button(window, text="Register", bg="green",font=("",20),fg="white", width=9, height=0, command = insert)
